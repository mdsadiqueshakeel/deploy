...
// // Define status tiers locally (same as in status.js)
// const STATUS_TIERS = [
//   {
//     name: "Consumer",
//     requiredTopup: 300,
...
//   // Calculate progress for next status
...
//       {/* Financial Overview - Two Cards Side by Side */}
...
//       {/* Next Status Achievement Card - Full Width */}
...
//                   {nextStatus.requiredStatus && nextStatus.requiredChildren > 0 && (
...
// //   const [currentStatus, setCurrentStatus] = useState(null);
// //   const [nextStatus, setNextStatus] = useState(null);
// //   const [eligibleForNextStatus, setEligibleForNextStatus] = useState(false);
...
// //         // FIX: Find the immediate next status the user hasn't achieved yet
// //         let next = null;
// //         for (let i = currentIndex + 1; i < STATUS_TIERS.length; i++) {
// //           const potentialNext = STATUS_TIERS[i];
// //           if (userPoints < potentialNext.requiredTopup / 100) {
// //             next = potentialNext;
// //             setEligibleForNextStatus(false);
// //             break;
// //           }
// //         }
        
// //         // If user has points for all next statuses, show highest
// //         if (!next && currentIndex < STATUS_TIERS.length - 1) {
// //           next = STATUS_TIERS[STATUS_TIERS.length - 1];
// //           setEligibleForNextStatus(true);
// //         }
