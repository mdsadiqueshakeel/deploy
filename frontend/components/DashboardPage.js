...
//         // Find the highest status the user has achieved
//         for (let i = STATUS_TIERS.length - 1; i >= 0; i--) {
//           if (userPoints >= STATUS_TIERS[i].requiredTopup / 100) {
//             current = STATUS_TIERS[i];
//             break;
//           }
//         }
        
//         // If no status found, set Consumer as current
//         if (!current) current = STATUS_TIERS[0];
        
//         // Find the next status
//         const currentIndex = STATUS_TIERS.findIndex(tier => tier.name === current.name);
//         if (currentIndex < STATUS_TIERS.length - 1) {
//           next = STATUS_TIERS[currentIndex + 1];
//         }
...
//                       {userPoints < (nextStatus.requiredTopup / 100) ? (
