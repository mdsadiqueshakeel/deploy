...
//     try {
//       const endpoint = currentRequest.type === 'topup' 
//         ? `/api/wallet/admin/topup-request/${currentRequest._id}/approve`
//         : `/api/wallet/admin/withdraw-request/${currentRequest._id}/approve`;
...
//     try {
//       const endpoint = currentRequest.type === 'topup' 
//         ? `/api/wallet/admin/topup-request/${currentRequest._id}/decline`
//         : `/api/wallet/admin/withdraw-request/${currentRequest._id}/decline`;
